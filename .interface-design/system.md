...
- Secondary action: border var(--fog), paper background, uppercase label
- Tables: paper header row, subtle row borders, uppercase header labels
- Forms: white inputs with fog borders, chalk focus
- Sections: label (uppercase) + title + helper text at top
